...
function App() {
  ...
  return (
    <div className="container mx-auto p-4 flex flex-col items-center text-center app-container">
      <h1 className="text-5xl font-extrabold mb-3 drop-shadow-2xl app-title">
        CineFind
      </h1>

      <p className="text-lg text-gray-300 mb-8 max-w-xl">
        Discover popular movies, search your favourites, and build your personal
        collection.
      </p>

      <div className="tabs tabs-boxed mb-8 app-tabs">
        <a
