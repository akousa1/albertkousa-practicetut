...
const ProductCard = ({ image, title, price, oldPrice, discount, status }) => {
    return (
        <div className='bg-white p-4 rounded shadow hover:shadow-lg transition relative overflow-hidden'>
            {discount && (
            ...
            <div className="mt-2 text-center">
                ...
                {oldPrice && (
                    <span className="text-gray-500 line-through m1-2">${oldPrice}</span>
                )}
            </div>
